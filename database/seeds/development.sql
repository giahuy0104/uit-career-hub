...
INSERT INTO student_documents (
    ...
    (
        '00000000-0000-4000-8000-000000005003', '00000000-0000-4000-8000-000000002002',
        'CV', 'CV_Data_PhamGiaHuy_2026.pdf', 'application/pdf', 398144,
        'demo/students/21520881/cv-data-v1.pdf', 'demo-checksum-cv-21520881-v1', 1, true, 'VERIFIED'
    )
ON CONFLICT DO NOTHING;
...
INSERT INTO applications (
    ...
    (
        '00000000-0000-4000-8000-000000008004', '00000000-0000-4000-8000-000000002002',
        '00000000-0000-4000-8000-000000007001', 'INTERVIEW_INVITED',
        now() - interval '6 days', now() - interval '6 days', now() - interval '2 hours'
    ),
    (
...
INSERT INTO application_status_history (
    ...
    ('20000000-0000-4000-8000-000000008010', '00000000-0000-4000-8000-000000008004', '21000000-0000-4000-8000-000000008010', NULL, 'UIT_REVIEWING', 'STUDENT', '00000000-0000-4000-8000-000000000012', NULL, NULL, now() - interval '6 days'),
    ('20000000-0000-4000-8000-000000008011', '00000000-0000-4000-8000-000000008004', '21000000-0000-4000-8000-000000008011', 'UIT_REVIEWING', 'FORWARDED_TO_COMPANY', 'UIT_ADMIN', '00000000-0000-4000-8000-000000000001', NULL, NULL, now() - interval '5 days'),
    ('20000000-0000-4000-8000-000000008012', '00000000-0000-4000-8000-000000008004', '21000000-0000-4000-8000-000000008012', 'FORWARDED_TO_COMPANY', 'COMPANY_REVIEWING', 'COMPANY', '00000000-0000-4000-8000-000000000101', NULL, NULL, now() - interval '4 days'),
...
INSERT INTO interviews (
    ...
    (
        '00000000-0000-4000-8000-000000010002', '00000000-0000-4000-8000-000000008004',
        '00000000-0000-4000-8000-000000000101', now() - interval '3 hours',
        'Asia/Ho_Chi_Minh', 'ONLINE', 'https://meet.example/demo-vng-8004',
        'Nguyễn Hoàng Nam', 'COMPLETED'
    )
ON CONFLICT DO NOTHING;
