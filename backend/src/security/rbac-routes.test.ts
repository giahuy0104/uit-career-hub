...
const restrictedEndpoints: RestrictedEndpoint[] = [
  ...
  { method: "get", path: "/api/v1/uit/placements", role: "UIT_ADMIN" },
  { method: "post", path: `/api/v1/uit/placements/${resourceId}/start`, role: "UIT_ADMIN" },
  { method: "post", path: `/api/v1/uit/placements/${resourceId}/complete`, role: "UIT_ADMIN" },
  ...
  { method: "get", path: "/api/v1/uit/taxonomy/categories", role: "UIT_ADMIN" },
  { method: "post", path: "/api/v1/uit/taxonomy/categories", role: "UIT_ADMIN" },
  { method: "patch", path: `/api/v1/uit/taxonomy/categories/${resourceId}`, role: "UIT_ADMIN" },
  { method: "post", path: `/api/v1/uit/taxonomy/categories/${resourceId}/archive`, role: "UIT_ADMIN" },
  { method: "post", path: `/api/v1/uit/taxonomy/categories/${resourceId}/reactivate`, role: "UIT_ADMIN" },
  { method: "get", path: "/api/v1/uit/taxonomy/skills", role: "UIT_ADMIN" },
  { method: "post", path: "/api/v1/uit/taxonomy/skills", role: "UIT_ADMIN" },
