...
Doanh nghiệp hiện đã có hàng đợi hồ sơ thật, chỉ thấy hồ sơ được UIT chuyển đúng đến doanh nghiệp của mình. Recruiter có thể bắt đầu sàng lọc, chọn “Không phù hợp”, tạo lịch phỏng vấn, ghi nhận kết quả `PASS/FAIL` và gửi offer khi ứng viên đạt. Sinh viên có thể rút đơn trước phỏng vấn, hủy tham gia phỏng vấn hoặc từ chối offer bằng hành động riêng của từng bước; lý do bắt buộc được lưu trong timeline và thông báo cho đơn vị liên quan. UIT có hàng đợi xác nhận nơi thực tập; khi xác nhận, đơn được chọn chuyển `HIRED`, mọi đơn khác còn hoạt động tự chuyển `WITHDRAWN` và lịch phỏng vấn liên quan bị hủy trong cùng transaction. Mọi thao tác đều cập nhật state machine, history, audit log, chống gửi lặp và thông báo đúng sinh viên/doanh nghiệp/UIT.

Happy flow tuyển dụng chính đã chạy xuyên suốt từ đăng tin đến xác nhận nhận việc. Luồng rút đơn và hủy tham gia phỏng vấn đã hoàn chỉnh; lát cắt tiếp theo nên xử lý sinh viên bổ sung rồi nộp lại hồ sơ theo yêu cầu của UIT.
