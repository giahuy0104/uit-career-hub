...
Màn “Hồ sơ & CV” của sinh viên dùng dữ liệu thật từ API: hiển thị thông tin UIT, tính độ hoàn thiện, cập nhật số điện thoại, upload/tải xuống PDF qua Cloudflare R2 private bằng URL ký trước và chọn CV đã xác minh làm mặc định. Backend kiểm tra MIME cùng dung lượng thực tế trên R2 trước khi tạo tài liệu ở trạng thái chờ UIT xác minh; xem hướng dẫn tại `docs/deployment/cloudflare-r2.md`.
